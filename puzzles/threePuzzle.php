...
$records = $conn->prepare('SELECT jsondata FROM `games` WHERE id_game = 123');
$records->execute();
...
$jsonP=$results;
 ...
 <body>
   ...
   <svg width="95%" height="600" id="entorno">
    <g id="fondo" style="border:1px solid black"><image xlink:href="../images/Puzzle/Tres/fondothree.png" width="350" height="334" x="500" y="17" style="border:1px solid black" viewBox="0 0 100 100"></g>
...
<p style="display:none;" id="valor2"></p>
 ...
 <audio id="three2" src="https://raw.githubusercontent.com/IdiomaKids/Idiomakidsapp/rescate/audios/tres.mp3">
 ...
 obj = JSON.parse(text);
 var url1 = '../images/Puzzle/Tres/three1.png';
 var url2 = '../images/Puzzle/Tres/three2.png';
 var url3 = '../images/Puzzle/Tres/three3.png';
 var url4 = '../images/Puzzle/Tree/three4.png';

 if (obj.position11 == "three11.png") {
 document.getElementById('demo11').setAttributeNS('', 'href', url1);

} if (obj.position12 == "three12.png"){
 document.getElementById('demo12').setAttributeNS('', 'href', url2);
 }

 if (obj.position21 == "three21.png") {
 document.getElementById('demo21').setAttributeNS('', 'href', url3);

} if (obj.position22 == "three22.png"){
