...
$records = $conn->prepare('SELECT jsondata FROM `games` WHERE id_game = 132');
$records->execute();
...
$jsonP=$results;
 ...
 <body>
   ...
   <svg width="95%" height="600" id="entorno">
    <g id="fondo" style="border:1px solid black"><image xlink:href="../images/Puzzle/Horse/fondohorse.png" width="350" height="334" x="500" y="17" style="border:1px solid black" viewBox="0 0 100 100"></g>
...
<p style="display:none;" id="valor"></p>
 ...
 obj = JSON.parse(text);
 var url1 = '../images/Puzzle/Horse/horse1.png';
 var url2 = '../images/Puzzle/Horse/horse2.png';
 var url3 = '../images/Puzzle/Horse/horse3.png';
 var url4 = '../images/Puzzle/Horse/horse4.png';

 if (obj.position11 == "horse11.png") {
 document.getElementById('demo11').setAttributeNS('', 'href', url1);

} if (obj.position12 == "horse12.png"){
 document.getElementById('demo12').setAttributeNS('', 'href', url2);
 }

 if (obj.position21 == "horse21.png") {
 document.getElementById('demo21').setAttributeNS('', 'href', url3);

} if (obj.position22 == "horse22.png"){
